...
```html
<canvas id="qr"></canvas>
<script src="https://cdn.jsdelivr.net/npm/quadqr-js@0.7.0/dist/quadqr.min.js"></script>
<script>
...
```html
<script src="https://unpkg.com/quadqr-js@0.7.0/dist/quadqr.min.js"></script>
```
...
<script type="module">
  import {
    encodeText,
    renderToCanvas
  } from "https://cdn.jsdelivr.net/npm/quadqr-js@0.7.0/dist/browser.js";
...
Pin a concrete package version such as `@0.7.0` in CDN URLs so an existing site does not silently change when a newer package version becomes available.
