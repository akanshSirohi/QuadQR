...
```html
<script src="https://unpkg.com/quadqr-js@1.5.5/dist/quadqr.min.js"></script>
```
...
<script type="module">
  import {
    encodeText,
    renderToCanvas
  } from "https://cdn.jsdelivr.net/npm/quadqr-js@1.5.5/dist/browser.js";
...
Pin a concrete package version such as `@1.5.5` in CDN URLs so an existing site does not silently change when a newer package version becomes available.
