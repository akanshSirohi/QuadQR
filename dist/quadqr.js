...
function sampleAxisAlignedTriangleGrid(imageData, bounds, size, radiusRatio = 0.085, insetRatio = 0.28) {
  const moduleW = bounds.width / size;
  const moduleH = bounds.height / size;
